...
from src.models.custom_losses import kl_divergence, reconstruction_loss 
...
model = loader(
            ...
            ) # get model from ./src/models

losses = {
	"kl_divergence": kl_divergence,
	"reconstruction_loss": reconstruction_loss,
}
loss_weights = {"kl_divergence": 1.0, "reconstruction_loss": 1.0}
...
list_train = datasets["train"][:128]
list_val   = datasets["val"][:128]
...
cb_checkpoint = tf.keras.callbacks.ModelCheckpoint(
    filepath='data/train/checkpoints/model-{epoch:02d}-{val_mse:.3f}.hdf5',
    monitor='val_loss',
    mode='min',
    save_best_only=True,
    verbose=1
